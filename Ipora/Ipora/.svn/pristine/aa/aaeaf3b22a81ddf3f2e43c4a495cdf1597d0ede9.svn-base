<!-- Autores
    Carlos Costa, Matheus Correia,
    Maxwel Allan, José Alberto
-->
<!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="col-md-12 column">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="dropdown pull-right">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle">Eventos<strong class="caret"></strong></a>
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="evento/listarEventos.jsp">Lista de Eventos</a>
                                </li>
                                <li>
                                    <a href="evento/adicionarEvento.jsp">Adicionar Evento</a>
                                </li>
...
=======
                        ...
                        <li class="dropdown pull-right">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle">Anunciante<strong class="caret"></strong></a>
                            <ul class="dropdown-menu">
                                <li>
                                     <a href="ListarAnuncianteServlet">Lista de Anunciantes</a>
                                </li>
                                <li>
                                    <a href="anunciante/alterarAnunciante.jsp">Alterar Dados do Anunciante</a>
                                </li>
                                
                                <li>
                                    <a href="anunciante/removerAnunciante.jsp">Excluir conta</a>
                                </li>
...
>>>>>>> .r29
                    ...
                    <div class="jumbotron">
                        <h1>
                            Menu de controle do Anunciante
                        </h1>
                        <p>
                            O Sistema Unificado de Cadastro de Eventos consiste em um cadastro único que podera informar sobres os eventos realizados pelo Instituto Federal Goiano - Câmpus Iporá
                        </p>

                    </div>
                    <div class="carousel slide" id="carousel-37436">
                        <ol class="carousel-indicators">
                            <li class="active" data-slide-to="0" data-target="#carousel-37436">
                            </li>
                            <li data-slide-to="1" data-target="#carousel-37436">
                            </li>
                            <li data-slide-to="2" data-target="#carousel-37436">
                            </li>
                        </ol>
                        <div class="carousel-inner">
                            ...
                            <div class="alert alert-success alert-dismissable">
                                ...
                                <strong></strong> Espaço destinado para anunciantes do Instituto Federal Goiano - Câmpus Iporá.
                            </div>    
                        </div>
                    <hr>
