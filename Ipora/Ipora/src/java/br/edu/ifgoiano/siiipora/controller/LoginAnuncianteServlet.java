 ...
 */
@WebServlet(name = "LoginAnuncianteServlet", urlPatterns = {"/LoginAnuncianteServlet"})
public class LoginAnuncianteServlet extends HttpServlet {
