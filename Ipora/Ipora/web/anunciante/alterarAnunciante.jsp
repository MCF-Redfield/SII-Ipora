                     ...
                     <div class="container">
                        <div class="row clearfix">
                            <div class="col-md-6 column">
                                        ...
                                        <h1>Alterar Anunciante</h1>
                                        <form action="../AlterarAnuncianteServlet" method="post">
                                            Digite os dados para alterar<BR>
                                            <BR>
                                            <label for="cpf">CPF</label><input type="" class="form-control" name="cpf" placeholder=<%=anunciante.getCpf()%> >
                                            
                                            <label for="nome">Novo Nome</label><input type="text" class="form-control" name="nome">
                                            <BR>
                                            <label for="nome">Nova Senha</label><input type="password" class="form-control" name="senha">
                                            <BR>
                                            <button type="submit" class="btn btn-default" name="alterar" value="alterar">Alterar</button>
                                        </form>
